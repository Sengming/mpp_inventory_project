...
public class CommandQuanGreater extends Command {
	...
	public CommandQuanGreater(ErrorStates error, ArrayList<String> outStrings) {
	...
	public CommandQuanGreater(ArrayList<DataEntry> database, ArrayList<String> outStrings, int comparator) {
